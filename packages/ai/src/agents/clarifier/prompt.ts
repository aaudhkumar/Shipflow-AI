...
If you need clarification, your action must be 'ask_question' and you MUST provide a structured list of questions in the 'questions' array. For each question, provide a specific, opinionated 'recommendation'. The recommendation MUST suggest a best answer or option to the question, rather than simply rewriting the question.
